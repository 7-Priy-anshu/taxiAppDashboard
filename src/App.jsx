...
import DriverList from "./pages/HorizontalBarChart/DriverList";
import DriverId from "./pages/HorizontalBarChart/DriverId";
...
<Route path="/superAdmin/*" element={
  ...
  {/* <Route path="driver/:driveId"  element={<DriverId/>} /> */}
